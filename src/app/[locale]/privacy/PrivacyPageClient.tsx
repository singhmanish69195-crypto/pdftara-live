        ...
        <section className="py-12">
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto prose prose-lg">
              ...
              <p className="text-[hsl(var(--color-muted-foreground))] mb-4">
                We use cookies to maintain website functionality and for advertising purposes:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-[hsl(var(--color-muted-foreground))] mb-4">
                <li><strong>Essential cookies:</strong> Required for the website to function properly.</li>
                <li><strong>Advertising cookies:</strong> We work with third-party partners (like Google AdSense) who may place cookies to show personalized ads.</li>
              </ul>
              ...
              <p className="text-[hsl(var(--color-muted-foreground))] mb-4">
                While we process files locally, we use trusted third-party services for site operations:
              </p>
              <ul className="list-disc pl-6 space-y-2 text-[hsl(var(--color-muted-foreground))] mb-4">
                <li><strong>Advertising:</strong> We use Google AdSense to support our free tools.</li>
                <li><strong>Analytics:</strong> We may use anonymous analytics to track site performance.</li>
              </ul>
              ...
              <p className="text-[hsl(var(--color-muted-foreground))] mb-4">
                You can clear your browser&apos;s local storage at any time to remove any 
              ...
              {/* --- SECTION 11: GOOGLE ADSENSE --- */}
              <h2 className="text-2xl font-bold text-[hsl(var(--color-foreground))] mt-8 mb-4">
                11. Advertising Partners (Google AdSense)
              </h2>
              <p className="text-[hsl(var(--color-muted-foreground))] mb-4">
              ...
              <div className="bg-[hsl(var(--color-muted)/0.3)] p-6 rounded-xl border border-[hsl(var(--color-border))]">
                <ul className="list-disc pl-6 space-y-2 text-[hsl(var(--color-muted-foreground))] text-sm">
                  <li>
                  ...
                  <li>
                    Users may opt out of personalized advertising by visiting <a href="https://www.google.com/settings/ads" target="_blank" rel="noopener noreferrer" className="text-blue-600 font-bold hover:underline">Google Ads Settings</a>.
                  </li>
                </ul>
              </div>
