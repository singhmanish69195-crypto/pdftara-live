...
<div align="center">
  <img src="public/images/logo.png" alt="PDFTara Logo" width="120" height="120" />
...
**PDFTara** is a comprehensive suite of PDF tools designed for privacy and performance. Unlike many online converters, PDFTara processes your files entirely within your browser using WebAssembly technology. Your documents **never** leave your device, ensuring maximum security for your sensitive data.
...
PDFTara includes a powerful **visual workflow editor** that allows you to chain multiple PDF operations together, creating automated processing pipelines.
...
PDFTara provides both pre-built Docker images and Docker Compose for flexible deployment options.

#### Option 1: Use Pre-built Image (Recommended)

The easiest way to run PDFTara is using our pre-built image from GitHub Container Registry:
...
PDFTara is configured for static export (`output: 'export'`), which means it can be deployed to any service that supports static website hosting without requiring a Node.js server.
...
PDFTara stands on the shoulders of giants. We gratefully acknowledge [BentoPDF](https://github.com/alam00000/bentopdf) for their pioneering work in privacy-first, client-side PDF tools.

Their project served as a significant inspiration and reference for our core logic. While PDFTara has been re-engineered for the Next.js ecosystem and extends functionality with unique features like the *Workflow Editor*, we deeply respect the foundation laid by the BentoPDF team.
...
<div align="center">
  Built with ❤️ by the PDFTara Team
</div>
